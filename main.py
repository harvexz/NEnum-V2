...
class MainGUI:
    def __init__(self):
        ...
        self.controller = con.Controller("127.0.0.1", 12345)
    ...
    def setup_single_client_tab(self):
        ...
        self.refresh_button = tk.Button(self.tab1, text="Refresh", command=self.update_connections)
    ...
    def update_connections(self):
        while True:
            # Update list boxes
            self.connections_listbox_tab1.delete(0, tk.END)
            #self.connections_listbox_tab2.delete(0, tk.END)
            for ip in self.controller.connections:
                self.connections_listbox_tab1.insert(tk.END, ip)
                #self.connections_listbox_tab2.insert(tk.END, ip)
